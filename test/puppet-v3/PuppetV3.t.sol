...
contract PuppetV3Challenge is Test {
    ...
    function setUp() public {
        ...
        // Mint enough tokens to the deployer
        uint256 totalTokensForDeployer = UNISWAP_INITIAL_TOKEN_LIQUIDITY + // liquidity to Uniswap
            PLAYER_INITIAL_TOKEN_BALANCE + // tokens we give the player
            LENDING_POOL_INITIAL_TOKEN_BALANCE; // tokens we fund the pool with

        token.mint(deployer, totalTokensForDeployer);
