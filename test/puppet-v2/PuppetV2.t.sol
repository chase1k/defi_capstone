...
contract PuppetV2Challenge is Test {
    ...
    function setUp() public {
        ...
        token = new ERC20Mint("DamnValuableToken", "DVT");
        weth = new WETH();
        ...
        token.mint(deployer, UNISWAP_INITIAL_TOKEN_RESERVE);
        ...
        token.mint(player, PLAYER_INITIAL_TOKEN_BALANCE);
        token.mint(address(lendingPool), POOL_INITIAL_TOKEN_BALANCE);
